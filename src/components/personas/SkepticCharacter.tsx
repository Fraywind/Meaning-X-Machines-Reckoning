  ...
  return (
    <>
      ...
      >
        ...
        {/* Eyes — narrowed slightly. Behind glasses. Pupils saccade subtly. */}
        <motion.g
        ...
        {/* Mouth — flat / pursed in idle; talks (open/close cycle) when thinking */}
        <motion.path
          stroke={ink}
          strokeWidth="2"
          fill="none"
          ...
          animate={{
            d: thinking
              ? [
                  "M 100 132 Q 110 131 120 132",
                  "M 99 133 Q 110 138 121 133",
                  "M 100 132 Q 110 130 120 132",
                  "M 99 133 Q 110 137 121 133",
                ]
              : "M 100 132 L 120 130",
          }}
          transition={{
            duration: thinking ? 1.5 : 0.5,
